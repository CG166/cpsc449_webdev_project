...
export default function Mens() {
  ...
  const menClothes = CATALOG.filter(p => p.category === "shirts" || p.category === "pants" || p.category === "shoes")

  return (
    <div>
        <Header />
        <main className="min-h-screen p-10">
          <h1 className="text-3xl font-bold mb-15 text-center ">Women's Clothing</h1>
